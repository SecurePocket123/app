...
public class PaymentsWocheFragment extends Fragment {
    ...
    private void loadTransactions() {
        ...
        List<Transaction> transactions = AppStorage.getInstance(requireContext()).getTransactionsThisWeek();
        adapter.setTransactions(transactions);

        if (transactions.isEmpty()) {
            tvEmpty.setText("Keine Zahlungen für diese Woche gespeichert.");
