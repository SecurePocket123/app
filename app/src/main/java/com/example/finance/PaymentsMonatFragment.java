...
public class PaymentsMonatFragment extends Fragment {
    ...
    private void loadTransactions() {
        ...
        List<Transaction> transactions = AppStorage.getInstance(requireContext()).getTransactionsThisMonth();
        adapter.setTransactions(transactions);

        if (transactions.isEmpty()) {
            tvEmpty.setText("Keine Zahlungen für diesen Monat gespeichert.");
